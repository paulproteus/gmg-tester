...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "mtxy58x9sy8dq7d3jgp1uw1m7cv0y71wj396pmguay6uf2n2vtyh",
...
const myCommand :Spk.Manifest.Command = (
  ...
  environ = [
    ...
    # Avoid Python crashing
    (key = "HOME", value = "/var"),
    # Don't let /tmp fill up; instead, waste user storage in /var
    (key = "TMP", value = "/var/tmp"),
